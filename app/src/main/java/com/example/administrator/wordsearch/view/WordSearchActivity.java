...
import com.example.administrator.util.AnalyticsTask;
import com.example.administrator.wordsearch.Constants;
import com.example.administrator.wordsearch.view.R;
import com.example.administrator.wordsearch.model.HighScore;
import com.example.administrator.wordsearch.util.AndroidHttpClient;
import com.example.administrator.wordsearch.util.ConversionUtil;
import com.example.administrator.wordsearch.view.controller.TextViewGridController;
import com.example.administrator.wordsearch.view.controller.WordSearchActivityController;
...
//			Debug.stopMethodTracing();
    ...
    class DialogNoWordsCustomListener implements DialogInterface.OnClickListener {
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                case DialogInterface.BUTTON_POSITIVE:
                    Intent intent = new Intent(Intent.ACTION_EDIT, com.example.administrator.wordsearch.view.WordDictionaryProvider.Word.CONTENT_URI);
                    intent.setType(com.example.administrator.wordsearch.view.WordDictionaryProvider.Word.CONTENT_TYPE);
